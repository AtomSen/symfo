...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\validator\\electronicvalidator' => 'AppBundle\\Validator\\ElectronicValidator',
        ...
        $this->methodMap = array(
            ...
            'AppBundle\\Validator\\ElectronicValidator' => 'getAppBundle_Validator_ElectronicValidatorService',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Validator\\ElectronicValidator' => true,
    ...
    {
        return $this->services['ElectronicController'] = new \AppBundle\Controller\ElectronicController(${($_ = isset($this->services['ElectronicService']) ? $this->services['ElectronicService'] : $this->get('ElectronicService')) && false ?: '_'}, ${($_ = isset($this->services['serializer']) ? $this->services['serializer'] : $this->get('serializer')) && false ?: '_'});
    }
    ...
    {
        return $this->services['ElectronicService'] = new \AppBundle\Services\ElectronicService(${($_ = isset($this->services['ElectronicRepository']) ? $this->services['ElectronicRepository'] : $this->get('ElectronicRepository')) && false ?: '_'});
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_3c87803537d359406626d2c7594291a707f08c83d0b4cc202492364c2ddc5550');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Validator\\ElectronicValidator' => function () {
            return ${($_ = isset($this->services['AppBundle\Validator\ElectronicValidator']) ? $this->services['AppBundle\Validator\ElectronicValidator'] : $this->getAppBundle_Validator_ElectronicValidatorService()) && false ?: '_'};
    ...
    /**
     * Gets the private 'AppBundle\Validator\ElectronicValidator' shared autowired service.
     *
     * @return \AppBundle\Validator\ElectronicValidator
     */
    protected function getAppBundle_Validator_ElectronicValidatorService()
    {
        return $this->services['AppBundle\Validator\ElectronicValidator'] = new \AppBundle\Validator\ElectronicValidator();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Tc2WW8U0Na', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vupdhe+xCO', 0, 'czAJoLm663x46-1rDYbtoV', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U1LjqWvjL+', 0, 'czAJoLm663x46-1rDYbtoV', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('43U6o8PU8c', 0, 'czAJoLm663x46-1rDYbtoV', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a16b14f5e2b78.59701037');
    }
