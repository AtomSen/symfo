 ...
 */
class Electronic extends \AppBundle\Entity\Electronic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Electronic' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Electronic' . "\0" . 'brand', '' . "\0" . 'AppBundle\\Entity\\Electronic' . "\0" . 'model', '' . "\0" . 'AppBundle\\Entity\\Electronic' . "\0" . 'price'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Electronic $proxy) {
